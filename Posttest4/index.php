    ...
    <section class="menu" id="menu">
        ...
        <div class="box-container">
            <div class="box">
                ...
                <div class="image">
                    <img src="images/burger.png" alt="" width="85%">
                </div>
                <div class="content">
                    <h3>Burger</h3>
    ...
    <section class="contact" id="contact">
        ...
        <div class="row">
            <form action="data.php" method="post">
                <input name="nama" type="text" placeholder="name*" class="box" required>
                <input name="email" type="email" placeholder="email" class="box">
                <input name="nomer" type="tel" placeholder="nomer hp*" class="box" required>
                <input name="alamat" type="text" placeholder="alamat*" class="box" required>
                <input name="pesanan" type="text" placeholder="Pesanan*" class="box" required>
                <input name="jumlah" type="number" min="1" value="1" placeholder="jumlah" class="box" required>
                <textarea name="message" class="box" placeholder="catatan" id="" cols="30"
                    rows="10"></textarea>
...
<script text="text/javascript" src="javascripts.js"></script>

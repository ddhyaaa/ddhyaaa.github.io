...
if (isset($_POST['login'])) {
    ...
    if ($username === 'admin' && $password === 'makan') {
        $_SESSION['login'] = true;
...
if (isset($error) && $error === true) {
    echo '<script>alert("Username atau Password tidak valid. Silahkan coba lagi.");</script>';
}
?>
<!-- HTML -->
...
<section class="contact" id="contact">
    ...
    <div class="row">
        <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
            ...
            <input type="submit" value="Masuk" name="login" class="btn-submit">
        </form>
    </div>
</section>

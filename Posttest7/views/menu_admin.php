...
<body>
    ...
    <h1 class="heading">
        <div class="tanggal">
            <center>
               <span>Tanggal:</span>  <?php echo date('l, d F Y'); ?>
               <br>
                <span>Waktu:</span> <?php echo date('H:i:s'); ?>
            </center>
        </div>
        </h1>
            ...
            <form>
                <table style="width: 100%; " align="center" cellpadding="10">
                        ...
                        <tr align="center">
                            ...
                            <td>
                                    <a href="edit2.php?ID=<?php echo $row["ID"] ?>" class="btn-form"> update </a>
                                    <a href="hapus2.php?ID=<?php echo $row["ID"] ?>" class="btn-form"> delete </a>
                            </td>
                ...
                <br>
                <a href="../views/data.php" class="btn-submit">Back</a>
                <a href="../views/menu.php" class="btn-submit">Tambah</a>
            </form>
